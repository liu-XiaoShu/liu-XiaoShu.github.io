...
前期讲述的都在 Ｍicropython 怎么开发，如没有讲解 Ｍicropython 怎么编译出来，本期就开始讲解一下 编译 ESP8266 的 Ｍicropython 固件 环境介绍: 1\. 操作系统
...
> 📎 **说明**：本文由 [CSDN「小树笔记」](https://blog.csdn.net/weixin_41596275/article/details/127687021) 迁移至 GitHub Pages，并在本站持续维护。（原 CSDN 标注为转载）
