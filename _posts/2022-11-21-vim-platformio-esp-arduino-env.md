...
前言 我想在 Ubuntu 下开发 STC/STM/ESP/Arduino 相关的产品应用，但是我又偏爱 Vim 和命令行的组合方式编辑代码而且环境需要用docker，不想使用 Vs Code 或者 Arduino ide要怎么弄
...
> 📎 **说明**：本文由 [CSDN「小树笔记」](https://blog.csdn.net/weixin_41596275/article/details/127916566) 迁移至 GitHub Pages，并在本站持续维护。
