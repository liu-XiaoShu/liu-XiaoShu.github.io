...
ESP8266开发板-Ｍicropython-串口控制继电器 硬件篇 1 开发板 ![在这里插入图片描述](
...
![示意图](/assets/img/posts/esp32-esp8266-05-relay-serial/img-01.png)
...
> 📎 **说明**：本文由 [CSDN「小树笔记」](https://blog.csdn.net/weixin_41596275/article/details/123504646) 迁移至 GitHub Pages，并在本站持续维护。
