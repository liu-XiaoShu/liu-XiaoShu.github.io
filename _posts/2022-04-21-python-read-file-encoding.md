...
１遇到文件中有错误编码的字符，会导致读取文件报错 一 现象 文件是想用utf-8解析，文件格式也是该格式，但是其中包含部分乱码，使用如下代码解析，会报错 f = open('test,txt', 'r') data = f.r
...
> 📎 **说明**：本文由 [CSDN「小树笔记」](https://blog.csdn.net/weixin_41596275/article/details/124319812) 迁移至 GitHub Pages，并在本站持续维护。
